...
export default function IndustryDetailHero({ industry }: IndustryDetailHeroProps) {
    ...
    <section ref={containerRef} className="relative pt-28 sm:pt-40 pb-12 sm:pb-24 lg:pt-56 lg:pb-40 bg-transparent overflow-hidden transition-colors duration-500">
      <div className="mx-auto max-w-[1248px] px-4 sm:px-5 relative z-10">
        <div className="max-w-[800px]">
          ...
          <p className="detail-hero-desc text-base sm:text-xl lg:text-2xl text-muted-foreground font-medium leading-relaxed max-w-[650px]">
      ...
      <div className="absolute top-1/2 right-[10%] -translate-y-1/2 hidden lg:block float-item">
        <div className="w-64 h-64 bg-brand-lime/10 dark:bg-brand-lime/15 rounded-[2rem] rotate-45 flex items-center justify-center backdrop-blur-3xl border border-border transition-colors duration-500">
